        ...
        while _G.TFPercentRefresh do
            ...
            if HP ~= 0 then
                if HP <= MinHP then
                    ...
                    game:GetService("ReplicatedStorage").RemoteEvent:FireServer(unpack(args))
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(123321, 321, 123321)
                    wait(1.7)
                    game.Players.LocalPlayer.Character.ForceField:Destroy()
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(Position)
                    wait(1.5)
...
Players:Button(
    ...
    function()
        if _G.SelectedPlr == "all" then
            ...
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(X, Y, Z)
            wait()
            game.ReplicatedStorage.RemoteEvent:FireServer({"Skill_SoulAttack_Start", game.Players[_G.SelectedPlr]})
            game.ReplicatedStorage.RemoteEvent:FireServer({"Skill_SoulAttack_End"})
            wait(.25)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(XA, YA, ZA)
        end
...
Players:Button(
    ...
    function()
        ...
        game:GetService("StarterGui"):SetCore(
            ...
            {
                Title = "Fist:" ..
                    converttoletter(string.format("%.0f", game.Players[_G.SelectedPlr].PrivateStats.FistStrength.Value)),
                Text = "Body:" ..
                    converttoletter(
                        ...
                        "\nSpeed:" ..
                            converttoletter(
                                string.format("%.0f", game.Players[_G.SelectedPlr].PrivateStats.MovementSpeed.Value)
                            ) ..
                                "\nJump:" ..
                                    converttoletter(
                                        string.format("%.0f", game.Players[_G.SelectedPlr].PrivateStats.JumpForce.Value)
                                    ) ..
                                        "\nPsychic:" ..
                                            converttoletter(
                                                string.format(
